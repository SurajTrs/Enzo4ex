...
export default function MT4About() {
  return (
        ...
        <div className="relative overflow-hidden rounded-[28px] border border-slate-800 text-white shadow-[0_16px_60px_rgba(2,6,23,0.6)]">
          ...
          <div className="relative p-8 md:p-12">
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-extrabold">Trade on MetaTrader 4 with ThinkMarkets</h2>
                <p className="mt-2 text-slate-200">MetaTrader is a powerful, customisable platform designed for multiple markets. Built for traders of all levels, MT4 offers a simple and reliable experience.</p>
                <div className="mt-4">
              ...
              <div className="relative">
                ...
                <div className="rounded-3xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur shadow-[0_16px_60px_rgba(0,0,0,0.45)]">
                  <img src={preview} alt="MT4 preview" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </div>
