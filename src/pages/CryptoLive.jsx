...
const symbols = [
  { label: "Bitcoin (BTCUSD)", value: "OANDA:BTCUSD" },
  { label: "Ethereum (ETHUSD)", value: "OANDA:ETHUSD" },
  { label: "Solana (SOLUSD)", value: "OANDA:SOLUSD" },
  { label: "Ripple (XRPUSD)", value: "OANDA:XRPUSD" },
  { label: "Cardano (ADAUSD)", value: "OANDA:ADAUSD" },
  { label: "Litecoin (LTCUSD)", value: "OANDA:LTCUSD" },
  { label: "Dogecoin (DOGEUSD)", value: "OANDA:DOGEUSD" },
  { label: "Polygon (MATICUSD)", value: "OANDA:MATICUSD" },
  { label: "Polkadot (DOTUSD)", value: "OANDA:DOTUSD" },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Live Crypto Prices & Chart</h1>
