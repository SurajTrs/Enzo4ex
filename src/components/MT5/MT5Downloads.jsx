...
export default function MT5Downloads() {
  const LINKS = {
    ...
    macos: "https://www.metatrader5.com/en/terminal/help/mac_os",
    ...
    web: "https://www.metatrader5.com/en/trading-platform/webterminal",
  };
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="rounded-3xl border border-purple-100 bg-white p-6 shadow-[0_12px_40px_rgba(16,24,40,0.08)]">
          <div className="text-center">
            <h3 className="text-xl md:text-2xl font-extrabold text-gray-900">Download MT5</h3>
