...
export default function StocksEducation() {
  const learn = [
    { title: "What are stocks and shares?", meta: "3 min · Beginners" },
    { title: "What moves the stock markets?", meta: "3 min · Beginners" },
    { title: "How to trade stocks?", meta: "3 min · Beginners" },
    ...
    <section className="relative py-16 bg-gradient-to-b from-white via-purple-50/30 to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-10 text-center">
          ...
          <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Learn as you trade</h3>
          <p className="text-gray-600">Learn how stock CFDs work, manage risk, and build confidence in your trading approach.</p>
        </div>
