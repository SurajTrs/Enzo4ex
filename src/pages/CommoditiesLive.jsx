...
export default function CommoditiesLive() {
  ...
  const [qty, setQty] = useState(1); // lots/contracts
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Live Commodities Prices & Chart</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="rounded-3xl border border-purple-100 bg-white shadow-sm p-5">
              ...
              <div className="mb-3">
                <label className="text-sm text-gray-600">Quantity (lots)</label>
            ...
            <div className="rounded-3xl border border-purple-100 bg-white shadow-sm p-5">
              ...
              <div className="space-y-2">
                ...
                {positions.map(p=>{
                  ...
                  const pnl = (price - p.avg) * p.qty; // simplified
                  return (
