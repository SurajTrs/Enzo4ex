...
export default function IndicesHero() {
  return (
    <section className="relative overflow-hidden">
      {/* Background image (placeholder). Provide an indices image to replace */}
      <img
        src={forexbg}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-20 md:py-28">
        ...
        <div className="flex flex-col items-start md:items-start gap-8 max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white">
            <span className="text-xs font-semibold bg-gradient-to-r from-purple-600 to-fuchsia-600 px-2 py-0.5 rounded-full">Indices</span>
            <span className="text-sm">Major markets · Seamless access & pricing</span>
          </div>

          {/* Heading */}
          <h1 className="text-white font-extrabold leading-tight text-4xl md:text-5xl lg:text-6xl">
            Trade all major indices
          </h1>

          {/* Subtext */}
          <p className="text-purple-100/95 text-lg md:text-xl leading-relaxed max-w-2xl">
            From SPX500 and NAS100 to UK100 and GER40, experience seamless trading on the world’s biggest indices. Trade a wide range of major global indices with all the tools, pricing, and flexibility you need.
          </p>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3 w-full max-w-xl">
            {[
              { label: "Spreads from", value: "0.4 pts" },
