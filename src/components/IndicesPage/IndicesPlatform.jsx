        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-purple-700 mb-3">
              ...
              <span className="text-sm font-medium">ThinkTrader: Your edge in the index markets.</span>
            </div>
            ...
            <p className="mt-4 text-gray-600 max-w-xl">
              ThinkTrader is our proprietary platform designed for traders who want more control, innovative tools, and seamless performance. Trade indices on a clean, intuitive interface backed by serious power.
            </p>
