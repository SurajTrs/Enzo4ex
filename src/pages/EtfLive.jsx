...
const symbols = [
  ...
  { label: "EEM", value: "AMEX:EEM" },
  { label: "XLK", value: "AMEX:XLK" },
  { label: "XLF", value: "AMEX:XLF" },
  { label: "HYG", value: "AMEX:HYG" },
...
export default function EtfLive() {
  ...
  const [watchlist, setWatchlist] = useState(() => {
    try {
      ...
      return s ? JSON.parse(s) : symbols.slice(0, 6).map((s) => s.value);
    } catch {
      return symbols.slice(0, 6).map((s) => s.value);
    }
  });
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900">Live ETF Prices & Chart</h1>
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <input
              type="text"
              placeholder="Type symbol e.g. AMEX:SPY"
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="rounded-3xl border border-purple-100 bg-white shadow-sm p-5">
              ...
              <div className="mb-3">
                <label className="text-sm text-gray-600">Quantity (shares)</label>
