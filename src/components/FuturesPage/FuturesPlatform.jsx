...
export default function FuturesPlatform() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-purple-700 mb-3">
              ...
              <span className="text-sm font-medium">Trade on ThinkTrader – built around you</span>
            </div>
            <h3 className="text-3xl md:text-4xl font-extrabold leading-tight text-gray-900">Fast execution, powerful tools, clean design</h3>
            <p className="mt-4 text-gray-600 max-w-xl">Get advanced charting, instant order execution and a clutter‑free interface. Trade futures, indices, forex and more with one login.</p>
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <a href="/futures/live" className="px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white font-semibold shadow-lg shadow-fuchsia-500/20 hover:opacity-95 transition inline-flex items-center gap-2"><FiExternalLink /> Get started</a>
