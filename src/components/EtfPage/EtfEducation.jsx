...
export default function EtfEducation() {
  const learn = [
    { title: "What are exchange-traded funds (ETFs)?", meta: "3 min · Beginners" },
    { title: "How to trade ETFs", meta: "3 min · Beginners" },
    { title: "What affects ETFs prices?", meta: "3 min · Beginners" },
    ...
    <section className="relative py-16 bg-gradient-to-b from-white via-purple-50/30 to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-600">Check out our Trading Academy to learn more about ETFs trading.</p>
        </div>
