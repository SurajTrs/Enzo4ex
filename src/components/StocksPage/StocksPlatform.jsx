...
export default function StocksPlatform() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-purple-700 mb-3">
              ...
              <span className="text-sm font-medium">Stock trading platform built for traders</span>
            </div>
            <h3 className="text-3xl md:text-4xl font-extrabold leading-tight text-gray-900">ThinkTrader is built for speed, clarity and ease</h3>
            <p className="mt-4 text-gray-600 max-w-xl">Get powerful charting, instant order execution and a clutter-free interface on desktop and mobile. Trade stocks, indices, forex, and more with a single login.</p>
            <ul className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3 text-gray-700">
              ...
              <li className="flex items-center gap-2"><FiBarChart2 className="text-purple-600" /> Advanced studies and templates</li>
              <li className="flex items-center gap-2"><FiSmartphone className="text-purple-600" /> Sync across desktop and mobile</li>
            </ul>
            <div className="mt-6 flex flex-wrap gap-4">
              <a href="/stocks/live" className="px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white font-semibold shadow-lg shadow-fuchsia-500/20 hover:opacity-95 transition inline-flex items-center gap-2"><FiExternalLink /> Start trading</a>
