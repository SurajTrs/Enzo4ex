...
export default function CryptoEducation() {
  const learn = [
    { title: "What is cryptocurrency?", meta: "3 min · Beginners" },
    { title: "What affects crypto prices?", meta: "3 min · Beginners" },
    { title: "How to start trading cryptocurrency", meta: "3 min · Beginners" },
    ...
    <section className="relative py-16 bg-gradient-to-b from-white via-purple-50/30 to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-10 text-center">
          ...
          <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">New to cryptocurrency trading?</h3>
          <p className="text-gray-600">You’ll find clear explanations, helpful guides, and practical tips.</p>
        </div>
