...
import { FiTrendingUp, FiMinusCircle, FiZap } from "react-icons/fi";
import whyright from "../../assets/whyright.png";

export default function StocksWhyTrade() {
  const items = [
    { icon: <FiTrendingUp className="w-5 h-5" />, title: "Trade rising and falling markets", desc: "Go long or short, depending on your market view." },
    { icon: <FiMinusCircle className="w-5 h-5" />, title: "No ownership", desc: "Skip the paperwork. Focus on the chart, not the certificate." },
    { icon: <FiZap className="w-5 h-5" />, title: "Bigger position sizes with leverage", desc: "Control a larger exposure with less capital." },
  ];
  return (
    <section id="stocks-why" className="relative py-20 bg-gradient-to-br from-[#0b1024] via-[#0b1024] to-[#121736] text-white overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 mb-3">
              ...
              <span className="text-sm">Why trade stocks as CFDs?</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight tracking-tight">Flexible exposure without ownership</h2>
            <p className="mt-3 text-purple-100/95 max-w-xl">With CFDs, you can trade price movements with leverage and no physical ownership.</p>
