...
export default function CommoditiesEducation() {
  const learn = [
    { title: "What are commodities?", meta: "3 min · Beginners" },
    { title: "What moves commodity prices?", meta: "3 min · Beginners" },
    { title: "How to trade gold", meta: "3 min · Beginners" },
    ...
    <section className="relative py-16 bg-gradient-to-b from-white via-purple-50/30 to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-600">Check out our Trading Academy to learn more about commodity trading.</p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {learn.map((a) => (
            <button
              type="button"
              key={a.title}
              className="group text-left p-6 rounded-3xl bg-white border border-purple-100 shadow-[0_10px_35px_rgba(16,24,40,0.06)] hover:shadow-[0_18px_55px_rgba(16,24,40,0.10)] transition-shadow relative overflow-hidden"
            >
